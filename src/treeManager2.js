function drawTree2(clickHandler) {
	var treeData = [
		{
			...
			"_children": [
				...
				{
					"name": "Portman",
					"description": "Ancestry: English (West Midlands): elaborated form of Port.",
					"parent": "Natalie Portman"
				},
				{
					"name": "OLD NAMES",
	...
	var svg = d3.select("div.natalie-portman-tree").append("svg")
